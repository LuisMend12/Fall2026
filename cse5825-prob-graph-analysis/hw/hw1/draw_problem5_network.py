"""Draws the Problem 5(a) Bayesian network: X -> W, Y -> W, W -> Z."""
import networkx as nx
import matplotlib.pyplot as plt

G = nx.DiGraph()
G.add_edges_from([("X", "W"), ("Y", "W"), ("W", "Z")])
...
ax.set_axis_off()
fig.tight_layout()
fig.savefig("problem5_network.png", dpi=200, bbox_inches="tight")
print("saved problem5_network.png")
